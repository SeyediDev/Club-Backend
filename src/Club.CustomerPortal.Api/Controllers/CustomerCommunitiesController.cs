...
using Club.CustomerPortal.Application.Features.Communities.Commands;
using Club.CustomerPortal.Application.Features.Communities.Queries;
...
/// </summary>
[Route("api/customer/communities")]
[Tags("customer/communities")]
[ApiController]
[Authorize]
public class CustomerCommunitiesController : AppControllerBase
{
    /// <summary>
