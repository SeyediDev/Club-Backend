...
using Club.CustomerPortal.Application.Features.Points.Commands;
using Club.CustomerPortal.Application.Features.Points.Queries;
...
[ApiController]
[Authorize]
public class CustomerPointsController : AppControllerBase
{
    [HttpGet("summary")]
