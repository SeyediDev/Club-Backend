...
public static class ChannelApiTelemetry
{
    ...
    public static readonly Counter<long> EventTypesRequestCounter = Meter.CreateCounter<long>(
        "club_channel_api_event_types_requests_total",
        "requests",
