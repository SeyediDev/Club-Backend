using Club.Channel.Api.Infrastructure;
...
{
    public static IServiceCollection AddClubChannelApiServices(this IServiceCollection services, 
		IConfiguration configuration, IHostEnvironment environment)
    {
        ...
        services.AddNeoControllerServices(configuration, "Club Channel API", includeViews: true, existingMvcBuilder: mvcBuilder);
