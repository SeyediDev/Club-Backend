using Club.AdminPanel.Domain.UiDefinitions.Analytics;
...
public partial class HomePageEntityUiDefinitions
{
    public partial class HomePageDashboard
    {
        ...
        public class ProductDashboard : DashboardConfigDefinition
        {
            ...
            protected override List<string> Roles => [Neo.Domain.Constants.Roles.Admin, ClubRoles.Manager, ClubRoles.Analyst, ClubRoles.MarketingManager];
