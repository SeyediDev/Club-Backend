using Club.AdminPanel.Domain.UiDefinitions.CustomerSegments;
using Club.AdminPanel.Domain.UiDefinitions.CustomerSegments.Base;
...
public partial class HomePageEntityUiDefinitions
{
    public partial class HomePageDashboard
    {
        ...
        public class CommunityMarketDashboard : DashboardConfigDefinition
        {
            ...
            protected override List<string> Roles => [Neo.Domain.Constants.Roles.Admin, ClubRoles.MarketingManager, ClubRoles.Analyst, ClubRoles.Manager];
