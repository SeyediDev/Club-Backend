...
using CustomerSegmentUiDefinitions = Club.AdminPanel.Domain.UiDefinitions.Customers.CustomerSegments.CustomerSegmentUiDefinitions;
...
// using FeedbackUiDefinitions = Club.AdminPanel.Domain.UiDefinitions.Feedback.CustomerFeedbackUiDefinitions;
