...
public partial class PromotionUiDefinitions
{
    public new partial class PublicReport : CRUDDefinition.PublicReport
    {
        ...
        {
            protected override List<string> Roles => [Neo.Domain.Constants.Roles.Admin, ClubRoles.MarketingManager, ClubRoles.Analyst];
        ...
        {
            protected override List<string> Roles => [Neo.Domain.Constants.Roles.Admin, ClubRoles.MarketingManager, ClubRoles.FinanceManager];
