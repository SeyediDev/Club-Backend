...
services:
  # برنامه شما
  clubbpms:
    image: clubbpms:latest
    build:
      context: .
      dockerfile: Club.Bpms/Club.Bpms.Web/Dockerfile
    ports:
      - "8080:80"
    environment:
...
```csharp
public static void AddClubBpmsServices(
...
127.0.0.1:6379> KEYS *
1) "ClubBpms_Product_1"
2) "ClubBpms_Product_List"

127.0.0.1:6379> GET ClubBpms_Product_1
"{\"Data\":{\"Id\":1,\"Title\":\"...\"},\"Version\":\"...\"}"

127.0.0.1:6379> TTL ClubBpms_Product_1
