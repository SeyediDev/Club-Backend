...
- **`club-sprite.svg`**: فایل SVG Sprite حاوی تمام آیکن‌های پلتفرم
- **`club-menu-icons.css`**: استایل‌های رنگی و انیمیشن آیکن‌ها
...
- `building-organization` - سازمان/تنانت
- `user-circle` - مشتری
...
<svg class="sidemenu-icon" viewBox="0 0 24 24">
    <use xlink:href="/Content/club-icons/club-sprite.svg#user-circle"></use>
</svg>
```
...
1. آیکن SVG را به `club-sprite.svg` اضافه کنید
2. نام آیکن را به `MenuHelper.UseClubIcon()` اضافه کنید
3. رنگ مناسب را در `club-menu-icons.css` تعریف کنید
...
- نام آیکن را با فایل `club-sprite.svg` مطابقت دهید
- کنسول مرورگر را برای خطاهای 404 چک کنید

### رنگ آیکن درست نیست
- `club-menu-icons.css` را بارگذاری شده است؟
...
- CSS `float: right` در `club-menu-icons.css` بررسی شود

---

**نسخه**: 1.0.0  
**تاریخ**: 2025-10-14  
**مخزن**: Club.Bpms Platform
