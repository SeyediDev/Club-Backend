...
document.addEventListener("DOMContentLoaded", function (event) {
    if (window.self !== window.top) {
        let element = document.getElementById("cando-header").children[0];
        element.children[1].remove();
        element.children[1].remove();
    }
});
(function () {
    $("#title-show-filter").click(function () { alert("sdfs");});
});