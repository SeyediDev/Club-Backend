...
public class PromotionService(
    ...
    IQueryRepository<Club.Domain.Entities.Promotions.Data.PromotionParticipation, int> participationRepo,
    IQueryRepository<CustomerTenant, int> customerTenantRepo) : IPromotionService
{
    ...
    private static Club.CustomerPortal.Application.Interfaces.PromotionDto MapToDto(
        Promotion p,
        DateTime now,
        ...
        bool? isActiveOverride = null)
    {
        ...
        return new Club.CustomerPortal.Application.Interfaces.PromotionDto
        {
            Id = p.Id,
            Title = p.Title,
