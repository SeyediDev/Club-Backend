...
using GetCustomerLotteryHistoryQuery = Club.CustomerPortal.Application.Features.Lotteries.Queries.GetCustomerLotteryHistoryQuery;
using GetCustomerLotteryHistoryQueryResponse = Club.CustomerPortal.Application.Features.Lotteries.Queries.GetCustomerLotteryHistoryQueryResponse;
using GetCustomerLotteryPositionQuery = Club.CustomerPortal.Application.Features.Lotteries.Queries.GetCustomerLotteryPositionQuery;
using GetCustomerLotteryPositionQueryResponse = Club.CustomerPortal.Application.Features.Lotteries.Queries.GetCustomerLotteryPositionQueryResponse;

namespace Club.CustomerPortal.Api.Controllers;

[AppRoute("club", "customer/lotteries")]
