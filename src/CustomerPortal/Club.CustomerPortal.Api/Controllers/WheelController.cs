using Club.CustomerPortal.Application.Features.Wheels.Commands;
using Club.CustomerPortal.Application.Features.Wheels.Queries;
using Microsoft.AspNetCore.Authorization;

namespace Club.CustomerPortal.Api.Controllers;

[AppRoute("club", "customer/wheel")]
[Tags("customer/wheel")]
[ApiController]
[Authorize]
