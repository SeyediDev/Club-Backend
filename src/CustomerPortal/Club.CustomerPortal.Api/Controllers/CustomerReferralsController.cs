...
using Club.CustomerPortal.Application.Features.Referrals.Commands;
using Club.CustomerPortal.Application.Features.Referrals.Queries;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;

namespace Club.CustomerPortal.Api.Controllers;

[Route("api/customer/referrals")]
[Tags("customer/referrals")]
[ApiController]
[Authorize]
public class CustomerReferralsController : AppControllerBase
{
    [HttpGet("stats")]
