...
using Club.CustomerPortal.Application.Features.Rewards.Commands;
using Club.CustomerPortal.Application.Features.Rewards.Queries;
...
[ApiController]
[Authorize]
public class CustomerRewardsController : AppControllerBase
{
    [HttpGet]
