...
طبق قوانین پروژه Club، نیازی به نوشتن SQL Migration Script نیست. پروژه یک ORM سفارشی دارد که با فراخوانی `migrationManager.StartMigration` (دو الی سه بار) DDL ها خودکار تولید و اجرا می‌شوند.
...
### Entities
- `Backend/src/Core/Club.Domain/Entities/Promotions/Enums/PromotionActionKind.cs`
- `Backend/src/Core/Club.Domain/Entities/Promotions/PromotionAction.cs`
- `Backend/src/Core/Club.Domain/Entities/Events/EventType.cs`

### Business Logic
- `Backend/src/Core/Club.Domain/Features/Promotions/PromotionActionService.cs`

### Jobs
- `Backend/src/Core/Club.Application/Features/Points/Jobs/IExpirePointsJob.cs`
- `Backend/src/Core/Club.Application/Features/Points/Jobs/ExpirePointsJob.cs`
- `Backend/src/Core/Club.Infrastructure/Features/Jobs/RegisterClubRecurringJobs.cs`

### UI Definitions
- `Backend/src/AdminPanel/Club.AdminPanel.Domain/UiDefinitions/Promotions/PromotionActionUiDefinitions.cs`
- `Backend/src/AdminPanel/Club.AdminPanel.Domain/UiDefinitions/Events/EventTypeUiDefinitions.cs`
- `Backend/src/AdminPanel/Club.AdminPanel.Domain/UiDefinitions/Customers/CustomerTransactions/CustomerTransactionUiDefinitions.cs`

### Tests
- `Backend/tests/Club.Application.Tests/Features/Points/ExpirePointsJobTests.cs`
- `Backend/tests/Club.Domain.Tests/Features/Promotions/PromotionActionServiceTests.cs`
