...
2. به پایگاه داده `ClubBpmsDev` متصل شوید
...
```powershell
cd "D:\Projects\Club\Backend\scripts"
sqlcmd -S localhost,1433 -d ClubBpmsDev -U sa -P "رمز_عبور_صحیح" -C -i "21_fix_province_iso2_mapping.sql"
```
