...
public class DemoScenarioIntegrationTests : IClassFixture<ClubWebApplicationFactory>
{
    ...
    public DemoScenarioIntegrationTests(ClubWebApplicationFactory factory)
    {
...
/// </summary>
public class ClubWebApplicationFactory : WebApplicationFactory<Club.Channel.Api.Program>
{
