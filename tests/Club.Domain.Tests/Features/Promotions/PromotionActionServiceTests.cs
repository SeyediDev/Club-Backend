...
//using Club.Domain.Entities.Plans.Data;
...
//using Club.Domain.Entities.Referal;
//using Club.Domain.Entities.Tenants.Data;
//using Club.Domain.Features.Points;
...
//        var lotteryRepoMock = new Mock<IQueryRepository<Club.Domain.Entities.Lotteries.Lottery, int>>();
//        var lotteryParticipantCmdRepoMock = new Mock<ICommandRepository<Club.Domain.Entities.Lotteries.LotteryParticipant, int>>();
