...
using CustomerSegmentMembershipData = Club.Domain.Entities.CustomerSegments.Data.CustomerSegmentMembership;
using PromotionParticipationData = Club.Domain.Entities.Promotions.Data.PromotionParticipation;

namespace Club.Domain.Tests;
