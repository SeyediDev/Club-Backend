...
Write-Host "🚀 Starting Club Backend Services..." -ForegroundColor Green
Write-Host ""
...
$CustomerPortalApi = Join-Path $BackendRoot "src\CustomerPortal\Club.CustomerPortal.Api"
$AdminPanel = Join-Path $BackendRoot "src\AdminPanel\Club.AdminPanel.Web"
$ChannelApi = Join-Path $BackendRoot "src\Channel\Club.Channel.Api"
...
Write-Host "   1. Start Frontend: cd D:\Projects\Club\Frontend\CustomerPortal\Club.CustomerPortal.Web && npm run dev" -ForegroundColor White
...
if ($startFrontend -ne "n") {
    $frontendPath = "D:\Projects\Club\Frontend\CustomerPortal\Club.CustomerPortal.Web"
