...
D:\Projects\Club\Backend\start-services.bat
```
...
```powershell
cd D:\Projects\Club\Backend\src\CustomerPortal\Club.CustomerPortal.Api
dotnet run --urls=http://localhost:5000
```

**Terminal 2 - Admin Panel:**
```powershell
cd D:\Projects\Club\Backend\src\AdminPanel\Club.AdminPanel.Web
dotnet run --urls=http://localhost:5001
```

**Terminal 3 - Frontend:**
```powershell
cd D:\Projects\Club\Frontend\CustomerPortal\Club.CustomerPortal.Web
npm run dev
```
...
```json
"ClubCommandConnection": "Server=localhost;Database=ClubDb;Trusted_Connection=True;TrustServerCertificate=True;"
```
...
cd src\CustomerPortal\Club.CustomerPortal.Api
