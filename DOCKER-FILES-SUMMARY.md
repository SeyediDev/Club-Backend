...
| فایل | مسیر | هدف |
|------|------|-----|
| `Dockerfile.new` | `D:\Projects\Club\Backend\src\AdminPanel\Club.AdminPanel.Web\` | ساخت image برای Admin Panel |
| `Dockerfile.new` | `D:\Projects\Club\Backend\src\Channel\Club.Channel.Api\` | ساخت image برای Channel API |
| `Dockerfile.new` | `D:\Projects\Club\Backend\src\CustomerPortal\Club.CustomerPortal.Api\` | ساخت image برای Customer Portal API |
...
| فایل | مسیر | Platform |
|------|------|----------|
| `.gitlab-ci.yml` | `D:\Projects\Club\Backend\` | GitLab CI/CD |
| `build-and-deploy.yml` | `D:\Projects\Club\Backend\.github\workflows\` | GitHub Actions |

### 4. مستندات

| فایل | مسیر | محتوا |
|------|------|-------|
| `DOCKER-README.md` | `D:\Projects\Club\Backend\` | راهنمای جامع استفاده |
| `DOCKER-FILES-SUMMARY.md` | `D:\Projects\Club\Backend\` | این فایل (خلاصه) |
...
- [ ] ساختار دایرکتوری درست است (`D:\Projects\{Club,Neo,Neo.Bpms}`)
...
```powershell
# از D:\Projects
docker build -f Club/Backend/src/AdminPanel/Club.AdminPanel.Web/Dockerfile.new -t club-admin:latest .
```
