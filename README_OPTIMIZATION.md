...
**Impact**: O(n²) → O(1)  
**File**: [AttributeValueService.cs](src/Core/Club.Domain/Features/Attributes/AttributeValueService.cs)  
**Methods**:
...
**File**: [AttributeValueService.cs](src/Core/Club.Domain/Features/Attributes/AttributeValueService.cs#L206-L249)  
**Methods Updated**:
...
**File**: [AttributeValueService.cs](src/Core/Club.Domain/Features/Attributes/AttributeValueService.cs#L404-L519)  
**Methods**:
